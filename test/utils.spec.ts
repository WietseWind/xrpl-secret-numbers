...
describe('Utils', () => {
  ...
  it('entropyToSecret', () => {
    ...
    const secret = ['304435', '457766', '267453', '461717', '300560', '644127', '076618', '024286']
  ...
  it('parseSecretString with spaces valid', () => {
    const secret = ['304435', '457766', '267453', '461717', '300560', '644127', '076618', '024286']
    expect(utils.parseSecretString('304435 457766 267453 461717 300560 644127 076618 024286')).toEqual(secret)
    expect(utils.parseSecretString('304435457766267453461717300560644127076618024286')).toEqual(secret)
    expect(utils.parseSecretString(`
      304435 457766
      267453 461717
      300560 644127
      076618 024286
